...
class COMMONSHARED_EXPORT VesselInfo PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT VesselTrack PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT BaseStationReport PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT AidtoNavigationReport PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT AIS PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT AISList PROTOBUF_FINAL :
...
class COMMONSHARED_EXPORT AisChart PROTOBUF_FINAL :
