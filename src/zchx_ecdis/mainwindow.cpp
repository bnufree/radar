...
extern bool zchx_ecdis_display_radar_history_track;
extern bool zchx_ecdis_display_radar_glow;
...
void MainWindow::initSignalConnect()
{
    ...
    connect(mMapWidget, SIGNAL(signalDrawRadarFilterArea(std::vector<std::pair<double,double> >)),
            this, SIGNAL(itfNewRadarFilterArea(std::vector<std::pair<double,double> >)));
    ...
    connect(mMapWidget, SIGNAL(signalSendCurPosAsRadarCenter(double,double)), this, SIGNAL(signalSendCurPosAsRadarCenter(double,double)));
    connect(mMapWidget, SIGNAL(signalRemoveItem(int,int)), this, SIGNAL(signalRemoveItem(int,int)));
}
...
void MainWindow::itfSetRadarVideoData(const QList<ZCHX::Data::ITF_RadarVideoImage> &list)
{
    m_dataMgrFactory->getRadarVideoMgr()->setRadarVideoData(list);
}
...
void MainWindow::itfSetRadarHistoryTrackDisplay(bool sts)
{
    zchx_ecdis_display_radar_history_track = sts;
}

void MainWindow::itfSetRadarGlowDisplay(bool sts)
{
