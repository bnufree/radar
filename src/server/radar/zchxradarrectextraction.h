...
class zchxRadarRectExtraction : public QObject
{
    Q_OBJECT
public:
    explicit zchxRadarRectExtraction(double lat, double lon, QObject *parent = 0);
    ...
    void  setFilterAreaData(const QList<zchxCommon::zchxFilterArea>& list);
...
private:
    ...
    QList<zchxCommon::zchxFilterArea>      mFilterAreaLatlonList;            //原生的过滤数据
