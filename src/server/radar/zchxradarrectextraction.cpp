...
zchxRadarRectExtraction::zchxRadarRectExtraction(double lat, double lon, QObject *parent) : QObject(parent)
{
    mCentreLat = lat;
    mCentreLon = lon;
    mImageWidth = 0;
...
void zchxRadarRectExtraction::setFilterAreaData(const QList<zchxCommon::zchxFilterArea> &list)
{
...
void zchxRadarRectExtraction::transferLatlonArea2PixelArea( bool lock)
{
    ...
    {
        zchxCommon::zchxFilterArea data = mFilterAreaLatlonList[i];
