    ...
    mChartWorker(0)
{
    ...
    mParam.mAisDataTopic = PROFILES_INSTANCE->value("PUBLISH", "AisTopic").toString();
    mParam.mDataSendPort = PROFILES_INSTANCE->value("PUBLISH", "AisPort", 0).toInt();
    mParam.mChartTopic = PROFILES_INSTANCE->value("PUBLISH", "AisChart", "AisChart").toString();
    mPrint = false;
    initChartWorker();
...
{   
    ...
    PUBLISH_INS->appendAisData(sendData);
#if 0
...
//    PUBLISH_INS->appendAisData(sendData, mParam.mChartTopic, mParam.mDataSendPort);
}
